/**
 * Client-safe portfolio domain logic: types, templates, sanitizers and pure
 * slug helpers. NO server imports (no supabaseAdmin, no env schema) so the
 * portfolios page can import PORTFOLIO_TEMPLATES without dragging the admin
 * client or the env schema into a public browser bundle (bundle-scan finding,
 * 2026-09-24). Server-side DB functions stay in lib/portfolios.ts.
 */
