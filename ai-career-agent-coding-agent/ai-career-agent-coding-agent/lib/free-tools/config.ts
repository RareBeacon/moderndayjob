...
export const FREE_TOOLS: FreeToolConfig[] = [
  {
    ...
    requiresAuthenticationToUnlock: true,
    deterministic: true,
    nextSteps: [{ label: 'Build my resume', href: '/generate' }, { label: 'Analyze a job description', href: '/free-job-description-analyzer' }, { label: 'Start an application', href: '/applications' }],
    questions: [
  ...
  },
  {
    ...
    supportsSave: true,
    requiresAuthenticationToUnlock: true,
    nextSteps: [{ label: 'Build my resume', href: '/generate' }, { label: 'Check my resume', href: '/free-ats-resume-scanner' }, { label: 'Start an application', href: '/applications' }],
    questions: [
  ...
  {
    id: 'salary-insights', name: 'Salary Insights', route: '/free-salary-insights', category: 'salary', description: 'Report only pay ranges explicitly stated in the listings you paste.', introTitle: 'Let us find salary signals without making up numbers.', intro: 'Tell me the role, then paste a listing or two. I will report only the pay they explicitly state.', outputType: 'salary', generationLabel: 'Check salary signals', progressMessages: ['Reading your pasted listings', 'Extracting stated pay only', 'Rejecting guesses', 'Preparing the answer'], supportsCopy: true, supportsDownload: true, supportsSave: true, requiresAuthenticationToUnlock: true, nextSteps: [{ label: 'Start an application', href: '/applications' }, { label: 'Match my skills', href: '/free-skills-matcher' }, { label: 'Build my resume', href: '/generate' }], questions: [
      { id: 'targetRole', label: 'What role should I check?', assistant: 'I will look for this role in the listings you paste.', type: 'text', required: true, minLength: 2, suggestions: roleSuggestions },
      ...
      { id: 'pastedListings', label: 'Paste job listings with pay', assistant: 'Paste one or more listings. I can only report pay they explicitly state.', type: 'textarea', required: false, placeholder: 'Paste one or more listings that mention pay...' },
    ] },
];
