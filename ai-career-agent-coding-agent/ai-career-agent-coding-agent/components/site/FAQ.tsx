...
const ITEMS = [
  ...
  { q: 'Is it really free?', a: 'Yes. The free tier is forever: 3 AI documents in total, 10 career-tool uses a day, ATS checks, job matching and tracking. Upgrade only when you want daily volume and automation.' },
